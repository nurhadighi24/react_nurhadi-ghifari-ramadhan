...
//Fungsi untuk inputan search dan search button
searchProduct = () => {
    searchButton.addEventListener('click', () => {
        ...
        updatedTableAfterSearched(filteredProducts);
        alert(
            `
...
//Fungsi untuk memperbarui tabel sesuai dengan inputan search
updatedTableAfterSearched = (displayProducts) => {
